"""
Django settings for apihtp project.
...
SECRET_KEY = 'django-insecure-)mx*0yew4u9tf$em1h(^6uz6snxf^2hlltk2x^d)=qo2wtw8g&'
...
#AUTH_USER_MODEL = 'usuarioshtp.Usuariohtp'
...
WSGI_APPLICATION = 'apihtp.wsgi.application'
