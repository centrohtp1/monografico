...
class Tarifa(models.Model):
    secciones_tarifa = models.OneToOneField(Seccion, on_delete=models.PROTECT,)
...
class CuentaPorCobrar(models.Model):
    estudiante = models.ForeignKey('estudiantes.Estudiante', on_delete=models.PROTECT,)  # Referencia en cadena
